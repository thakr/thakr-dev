    ...
    <>
      ...
      <div className="h-screen w-screen flex justify-center items-center">
        <div className="flex flex-col items-center">
          ...
          <motion.div initial={{opacity:0, y:100}} animate={{opacity:1, y:0}} className="flex mt-10 gap-5">
            <button className="cursor-pointer text-center px-4 py-3 sm:px-3 sm:py-2 focus:outline-none rounded-lg bg-transparent border-gray-300 border-2 text-gray-500 font-semibold hover:border-black hover:text-black transition ease-in-out duration-200 text-2xl sm:text-xl" onClick={() => router.push('contact')}>Contact</button>
            <button className="cursor-pointer text-center px-4 py-3 sm:px-3 sm:py-2 focus:outline-none rounded-lg bg-black border-black border-2 text-white font-semibold hover:bg-transparent hover:text-black transition ease-in-out duration-200 text-2xl sm:text-xl" onClick={() => router.push('works')}>View works</button>
          </motion.div>
        </div>
      </div>
    </>
