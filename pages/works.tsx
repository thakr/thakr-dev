  ...
  return (
    <>
      ...
      <Link href="/contact" passHref={true}>
        <motion.div className="flex flex-row justify-center items-center cursor-pointer group absolute sm:bottom-3 bottom-10 left-[50vw] ml-[-6rem]" initial={{opacity: 0, y: -50}} animate={{opacity: 1, y: 0}}>
